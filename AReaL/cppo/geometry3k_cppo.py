"""CPPO Training Script using PPOTrainer (alternative approach)."""

import re
import sys

from areal.api.cli_args import GRPOConfig, load_expr_config
from cppo.dataset import get_geometry3k_cppo_rl_dataset
...
def main(args):
    ...
    train_dataset = get_geometry3k_cppo_rl_dataset(
    ...
    valid_dataset = get_geometry3k_cppo_rl_dataset(
