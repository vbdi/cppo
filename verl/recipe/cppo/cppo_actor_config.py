...
class ActorConfig(BaseConfig):
    ...
    Args:
        ...
        use_vision_cpl_loss (bool): Whether to use the CPL loss for vision training.
        cpl_loss_coef (float): Coefficient for the vision CPL loss when use_vision_csl_loss is True.
    ...
    csl_loss_coef: float = 0.01
    use_vision_mask: bool = False
    csl_vision_top_percent: float = 0.5
    use_advantage_gating: bool = False
    ...
    use_vision_cpl_loss: bool = False
    cpl_loss_coef: float = 0.01
