...
TEST_FREQ=10
EPOCHS=2
N_GPUS=8 #TODO: change if needed

## TODO:
PROJECT_NAME="Qwen2.5-VL-7B-Instruct-virl39k-CPPO"  # TODO: change if needed
...
TRAIN_DATA="../data/virl39k_verl/train.parquet" # TODO: change if needed
VAL_DATA="../data/geometry3k_verl/test.parquet" # TODO : change if needed

SAVE_DIR="checkpoints/$PROJECT_NAME/$EXP_NAME" # TODO: change if needed
MODEL_PATH="../pretrained_models/Qwen2.5-VL-7B-Instruct" # TODO: change if needed
...
python3 -m recipe.cppo.cppo_main_ppo \
    ...
    actor_rollout_ref.actor.cpl_tau=${CPL_TAU} \
